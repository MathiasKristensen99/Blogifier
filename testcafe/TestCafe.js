...
test.page("http://localhost:5000/admin/register")("ItWorks", async t => {
    await t
        .typeText("#registerEmail", "test@gmail.com")
        .typeText("#registerName", "TestAdmin")
        .typeText("#registerPassword", "123456")
...
test.page("http://localhost:5000/admin/login")("EmailDoesntExist", async t => {
    await t
...
test.page("http://localhost:5000/admin/login")("PasswordDoesntExist", async t => {
    await t
...
test.page("http://localhost:5000/admin/login")("RedirectToDashboard", async t => {
    await t
        .typeText("#loginEmail", "test@gmail.com")
        .typeText("#loginPassword", "123456")
